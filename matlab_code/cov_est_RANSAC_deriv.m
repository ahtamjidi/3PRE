...
function res = cov_est_RANSAC_deriv(Ya, Yb,R_ab,T_ab)
...
dg2Ek_dxde1 = zeros(7,1);
dg2Ek_dxde2 = zeros(7,1);
dg2Ek_dxde3 = zeros(7,1);
dg2Ek_dxde4 = zeros(7,1);
dg2Ek_dxde5 = zeros(7,1);
dg2Ek_dxde6 = zeros(7,1);
...
%         norm(sph2cart(a_theta_, a_phi_, a_r_) -(q2R(quat_ab_)*sph2cart(b_theta_, b_phi_, b_r_)+T_ab_))^2;
    ...
    gradEk = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ , ...
        ...
        [deriv(@(tt1)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ , quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,tt1,T_ab_2_,T_ab_3_),T_ab_1_,eps_xy);...
        
        deriv(@(tt2)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,tt2,T_ab_3_),T_ab_2_,eps_xy);...
        
        deriv(@(tt3)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,tt3),T_ab_3_,eps_xy);...
        
        deriv(@(qq1)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,qq1 , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_1_,eps_xy);...        
        
        deriv(@(qq2)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , qq2,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_2_,eps_xy);...        
        
        deriv(@(qq3)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,qq3,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_3_,eps_xy);...        
        
        deriv(@(qq4)E_k_func(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,qq4...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_4_,eps_xy);...                
        ];
    ...
    d2Ek_dx2 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ , ...
        quat_ab_1_,quat_ab_2_,quat_ab_3_,quat_ab_4_,...
        T_ab_1_, T_ab_2_, T_ab_3_ )...
        [deriv(@(tt1)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ , quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,tt1,T_ab_2_,T_ab_3_),T_ab_1_,eps_xy),deriv(@(tt2)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,tt2,T_ab_3_),T_ab_2_,eps_xy),deriv(@(tt3)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,tt3),T_ab_3_,eps_xy),deriv(@(qq1)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,qq1 , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_1_,eps_xy),deriv(@(qq2)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , qq2,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_2_,eps_xy),deriv(@(qq3)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,qq3,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_3_,eps_xy),deriv(@(qq4)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,qq4...
        ,T_ab_1_,T_ab_2_,T_ab_3_),quat_ab_4_,eps_xy)                
        ];        
    ...
    d2Ek_dxde1 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e1)gradEk(e1, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),b_theta_,eps_xy);
    
    d2Ek_dxde2 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e2)gradEk(b_theta_, e2, b_r_, a_theta_, a_phi_, a_r_ , quat_ab_1_, quat_ab_2_, quat_ab_3_,quat_ab_4_,...
        T_ab_1_,T_ab_2_,T_ab_3_),b_phi_,eps_xy);
    
    d2Ek_dxde3 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e3)gradEk(b_theta_, b_phi_, e3, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),b_r_,eps_xy);
    
    d2Ek_dxde4 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e4)gradEk(b_theta_, b_phi_, b_r_, e4, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),a_theta_,eps_xy);
    
    d2Ek_dxde5 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e5)gradEk(b_theta_, b_phi_, b_r_, a_theta_, e5, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),a_phi_,eps_xy);
    
    d2Ek_dxde6 = @(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, a_r_ ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_)...
        deriv(@(e6)gradEk(b_theta_, b_phi_, b_r_, a_theta_, a_phi_, e6 ,quat_ab_1_ , quat_ab_2_,quat_ab_3_,quat_ab_4_...
        ,T_ab_1_,T_ab_2_,T_ab_3_),a_r_,eps_xy);
...
%     dg2Ek_dxde6(:,i) = dg2Ek_dxde6(:,i) + de6;
    ...
    dg2Ek_dxde1 = dg2Ek_dxde1 + de1;
    dg2Ek_dxde2 = dg2Ek_dxde2 + de2;
    dg2Ek_dxde3 = dg2Ek_dxde3 + de3;
    dg2Ek_dxde4 = dg2Ek_dxde4 + de4;
    dg2Ek_dxde5 = dg2Ek_dxde5 + de5;
    dg2Ek_dxde6 = dg2Ek_dxde6 + de6;
