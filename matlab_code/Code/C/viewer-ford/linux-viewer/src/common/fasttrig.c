...
void fasttrig_sincos_coarse(double theta, double *s, double *c)
{
...
double fasttrig_atan2_coarse(double y, double x) 
{
	double abs_y = fabs(y);
	double angle;
